...
Implementation of the Internal Coherence Maximization (ICM) algorithm for unsupervised elicitation on TruthfulQA, completed as part of the MATS 9.0 Program work test and interview.
